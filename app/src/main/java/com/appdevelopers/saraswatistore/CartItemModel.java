...
public class CartItemModel {
    ...
    private String productQuantityDetails;
    private boolean inStock;
    private List<String> qtyIDs;
    private boolean qtyError;

    public CartItemModel(int type, String productID, String productImage, String productTitle, String productPrice, String cuttedPrice, Long productQuantity, String productQuantityDetails,boolean inStock,Long maxQuantity,Long stockQuantity) {
        this.type = type;
